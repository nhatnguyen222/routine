    ...
    public class CheckOutController : Controller
    {
        ...
        public ActionResult CheckOut(string tenkh, string email, string phone, string diachi, string city, string district, string tongtien,string payment)
        {
            if (payment == "momo")
            {
                ...
                string partnerCode = "MOMOSLKH20220324";
                string accessKey = "jcPdD7MejkrRYCKZ";
                string serectkey = "8jbvyc82wXSrrSberoN7xoBwhkSqgngD";
                string orderInfo = "Thanh Toán Mua Hàng Routine";
